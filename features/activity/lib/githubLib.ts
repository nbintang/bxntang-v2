...
export const transformData = (
  data: Array<GithubActivityProps>,
  transformFn?: (data: Array<GithubActivityProps>) => Array<unknown>,
): Array<GithubActivityProps> => {
  ...
  return transformedData as Array<GithubActivityProps>
}
